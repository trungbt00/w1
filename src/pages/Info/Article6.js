        ...
        <Container className="mt-5">
            <Row>
                <Col md={{ span: 10, offset: 1 }}>
                    ...
                    <p>
                        <h2 class="singular-sapo">(Dân trí) - Trong phiên đấu giá biển số tới đây, đơn vị tổ chức đấu giá biển số xe sẽ đưa ra hơn 1,55 triệu biển số mô tô, xe gắn máy lên sàn. Gần 625.000 biển số còn lại là biển số ô tô.</h2>
