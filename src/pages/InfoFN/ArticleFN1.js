        ...
        <Container className="mt-5">
            <Row>
                <Col md={{ span: 10, offset: 1 }}>
                    ...
                    <p>
                        <h3 class="singular-sapo">(Dân trí) - Với hơn 2 triệu biển số đưa ra đấu giá, trên 50.000 biển đấu giá thành công, cùng công nghệ hiện đại, quy trình tinh gọn, Công ty đấu giá hợp danh Việt Nam ghi dấu ấn sau một năm vận hành thí điểm hoạt động này, thu về ngân sách hàng nghìn tỷ đồng.</h3>
